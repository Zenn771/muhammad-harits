      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-6">
        ...
        <div className="col-span-1 md:col-span-2">
          <BentoCard
            ...
            icon={<bentoCardsData[0].icon className={`h-5 w-5 text-${bentoCardsData[0].gradient.split('-')[1]}-300`} />}
        ...
        <div className="col-span-1 md:col-span-1">
          <BentoCard
            ...
            icon={<bentoCardsData[1].icon className={`h-5 w-5 text-${bentoCardsData[1].gradient.split('-')[1]}-300`} />}
        ...
        <div className="col-span-1 md:col-span-1">
          <BentoCard
            ...
            icon={<bentoCardsData[2].icon className={`h-5 w-5 text-${bentoCardsData[2].gradient.split('-')[1]}-300`} />}
        ...
        <div className="col-span-1 md:col-span-1">
          <BentoCard
            ...
            icon={<bentoCardsData[3].icon className={`h-5 w-5 text-${bentoCardsData[3].gradient.split('-')[1]}-300`} />}
        ...
        <div className="col-span-1 md:col-span-2">
          <BentoCard
            ...
            icon={<bentoCardsData[4].icon className={`h-5 w-5 text-${bentoCardsData[4].gradient.split('-')[1]}-300`} />}
        ...
        <div className="col-span-1 md:col-span-1">
          <BentoCard
            ...
            icon={<bentoCardsData[5].icon className={`h-5 w-5 text-${bentoCardsData[5].gradient.split('-')[1]}-300`} />}
        ...
        <div className="col-span-1 md:col-span-3">
          <BentoCard
            ...
            icon={<bentoCardsData[6].icon className={`h-5 w-5 text-${bentoCardsData[6].gradient.split('-')[1]}-300`} />}
